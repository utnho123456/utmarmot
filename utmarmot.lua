...
getgenv().gagConfig = {
   ...
   MAX_PLANTS = 200,
    ...
    PLANT_EGGS = { "Bug Egg", "Anti Bee Egg", "Fall Egg", "Paradise Egg", "Enchanted Egg", "Gourmet Egg", "Zen Egg",  "Sprout Egg", "Corrupted Zen Egg", "Bee Egg", "Night Egg", "Dinosaur Egg", "Primal Egg", "Mythical Egg", "Common Summer Egg", "Rare Egg", "Rare Summer Egg" },
    ...
    KEEP_PETS = { "Red Panda", "Barn Owl", "Swan", "Phoenix", "Drake", "Wisp", "Luminous Sprite", "Cockatrice", "Drake", ["Glimmering Sprite"] = 8, "Tanchozuru", "Kappa", "Green Bean", "Apple Gazelle", "Gnome", "Griffin", "Golden Goose", "Spriggan", "Junkbot", ["Gorilla Chef"] = 1, "Lobster Thermidor", "French Fry Ferret", "Corrupted Kitsune", "Raiju", "Mizuchi", "Kitsune", "Koi", "Bald Eagle", "Ankylosaurus", "Spinosaurus", "Brontosaurus", "T-Rex", "Fennec Fox", "Disco Bee", "Raccoon", "Queen Bee", "Night Owl", "Dragonfly", "Butterfly", "Mimic Octopus", "Red Fox", "Chicken Zombie", ["Jackalope"] = 1, ["Corrupted Kodama"] = 6, ["Spaghetti Sloth"] = 1, ["Capybara"] = 1, ["Starfish"] = 2, ["Rooster"] = 8, ["Sunny-Side Chicken"] = 5 },
    KEEP_PETS_WEIGHT = 7,
    KEEP_PETS_AGE = 75,

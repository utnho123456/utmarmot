...
getgenv().gagConfig = {
    ...
    PLANT_EGGS = { "Zen Egg", "Sprout Egg", "Anti Bee Egg", "Paradise Egg", "Bug Egg",  "Gourmet Egg", "Corrupted Zen Egg", "Bee Egg", "Night Egg", "Dinosaur Egg", "Primal Egg", "Mythical Egg", "Common Summer Egg", "Rare Egg", "Rare Summer Egg" },

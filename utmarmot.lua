...
getgenv().gagConfig = {
   ...
   MAX_PLANTS = 200,
    ...
    PLANT_EGGS = { "Bug Egg", "Fall Egg", "Anti Bee Egg", "Paradise Egg", "Enchanted Egg", "Gourmet Egg", "Zen Egg",  "Sprout Egg", "Corrupted Zen Egg", "Bee Egg", "Night Egg", "Dinosaur Egg", "Primal Egg", "Mythical Egg", "Common Summer Egg", "Rare Egg", "Rare Summer Egg" },
